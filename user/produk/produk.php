              ...
              <div class="col-4 d-flex align-items-stretch my-2">
                <div class="card p-3">
                  <img src="../../img/<?=$row['gambar']?>" class="card-img-top" alt="" style="height: 200px">        
                    ...
                    <a class="btn btn-primary  mt-3 d-block mt-auto" href="../reservasi/reservasi.php?id_paket=<?=$row['id_paket']?> & nama_paket=<?=$row['nama_paket']?> & gambar=<?=$row['gambar']?> & deskripsi=<?=$row['deskripsi']?> & harga=<?=$row['harga']?>">Rp. <?=$row['harga']; ?></a>
